...
<head>
    ...
    <title>The Pastry Gallery - Register</title>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <p>Join the pastry paradise by filling out our registration form below. Unlock a world of delectable treats, exclusive offers, and delightful surprises. Don't miss out on the sweetest experiences, register now!</p>
            <form role="form">
            <style>
        form {
            display: flex;
